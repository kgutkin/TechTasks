...
public class StreamTask {
    ...
    /**
     * Напишите программу,  подсчитывающую в строке частоту появления слов, и в конце выводящую 10 наиболее часто встречающихся слов.
     ...
     * mi
     */
    public static List<String> getTop10FrequencyWord(String str) {
        // TODO
        return null;
    }
}
